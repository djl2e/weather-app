...
function changeCurrentDisplay(description, city, dateTime, temperature, iconId) {
  const currentWeatherCard = (0,_card__WEBPACK_IMPORTED_MODULE_0__["default"])(dateTime, temperature, iconId);
...
function changeTopDisplay(
  ...
  (0,_ui_current__WEBPACK_IMPORTED_MODULE_0__.changeCurrentDisplay)(description, city, time, temperature, icon);
  (0,_ui_current__WEBPACK_IMPORTED_MODULE_0__.changeAccessoryDisplay)(feels, humidity, rain, wind);
}
...
async function main() {
  const weatherInfo = await (0,_js_modules_weather__WEBPACK_IMPORTED_MODULE_1__.getWeather)(city);
